...
def wind_energy_plot(data):
    ...
    data_total_periods_avoided = data_total_periods[[
        "Perioden", "VermedenVerbruik_3"]]

    # create barchart for total avoided use of fossil energy due to wind power in period 2010-2018
    barchart = data_total_periods_avoided.plot.bar(
        x="Perioden", y="VermedenVerbruik_3", legend=False, title="Total avoided use of fossil energy due to wind power")
