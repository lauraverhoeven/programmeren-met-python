...
def biomassa_wood_plot(data):
  ...
  barchart = data_total_periods_avoided.plot.bar(x="Perioden",y="Verbruik_3", legend=False, title="Difference in used Biomassa between wooden and pallet stove in households")
